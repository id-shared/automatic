...
int main() {
  ...
  Driver::read([&driver](Driver::Byte o1_1[13], std::array<bool, 4> o1) {
    ...
    bool a1 = n1 == 1;
    a1 == o1[0] ? true : Xyloid1::ea(driver, 0x1a, a1);

    bool a2 = n1 == 4;
    a2 == o1[1] ? true : Xyloid1::ea(driver, 0x1b, a2);

    bool a3 = n1 == 8;
    a3 == o1[2] ? true : Xyloid2::e1(driver, a3);

    bool a4 = n1 == 16;
    a4 == o1[3] ? true : Xyloid2::e2(driver, a4);
